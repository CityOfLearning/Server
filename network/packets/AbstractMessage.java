package com.dyn.server.network.packets;
...
public abstract class AbstractMessage<T extends AbstractMessage<T>> implements IMessage, IMessageHandler<T, IMessage> {
	...
	// =====================================================================//
	/*
	 * Make the implementation so child classes don't need to bother with it,
	 * since the message class shouldn't have anything to do with the handler.
	 * This is simply to avoid having to have:
	 *

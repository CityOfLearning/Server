...
public class GroupPermissionsMessage extends AbstractClientMessage<GroupPermissionsMessage> {
	...
	// automated handling
	public GroupPermissionsMessage() {
	}

	// We need to initialize our data, so provide a suitable constructor:
	public GroupPermissionsMessage(List<String> permissions) {

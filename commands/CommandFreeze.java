			...
			if (args[0].equals("add")) {
				for (String arg : args) {
					try {
						...
						PacketDispatcher.sendTo(new FreezePlayerMessage(true), (EntityPlayerMP) entityplayer);
			...
			if (args[0].equals("remove")) {
				for (String arg : args) {
					try {
						...
						PacketDispatcher.sendTo(new FreezePlayerMessage(false), (EntityPlayerMP) entityplayer);
